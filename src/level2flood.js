...
export default class Level2Scene extends Phaser.Scene {
  ...
  createWaterBackground() {
    ...
    for (let i = 0; i < 15; i++) {
      ...
      const ripple = this.add.circle(x, y, 5 + Math.random() * 15, 0x4499ff, 0.2).setDepth(0.2);
  ...
  createEnhancedInstructions() {
    ...
    const missionBg = this.add.rectangle(0, 0, 500, 80, 0x1a4d8b, 0.9) // Blue for water theme
      .setStrokeStyle(3, 0x44aaff);
    
    const missionText = this.add.text(0, -10, '🚨 EMERGENCY: DRAIN FLOODED AREAS! 🚨', {
      fontSize: '16px',
    ...
    const missionSubtext = this.add.text(0, 15, 'Blue areas are flooded and need drainage pipes!', {
      fontSize: '12px',
      fontFamily: 'Courier New',
      color: '#aaddff'
    }).setOrigin(0.5);
    ...
    const controlsBg = this.add.rectangle(0, 0, 450, 60, 0x0a2f4a, 0.9)
      .setStrokeStyle(2, 0x4499dd);
    
    const controlsText = this.add.text(0, 0, 'ARROWS: Move Farmer    SPACEBAR: Pick Up/Drop Drainage Pipes', {
      fontSize: '12px',
      fontFamily: 'Courier New',
      color: '#66ccff'
    }).setOrigin(0.5);
  ...
  createTitle() {
    ...
    this.titleText = this.add.text(width / 2, 35, 'Flood Stories - Level 2', {
      fontSize: '26px',
      fontFamily: "'Press Start 2P', Courier New",
      color: '#66ccff',
      fontStyle: 'bold'
    ...
    const subtitle = this.add.text(width / 2, 58, 'Drainage Mission', {
      fontSize: '12px',
      fontFamily: 'Courier New',
      color: '#88ddff',
      fontStyle: 'italic'
  ...
  createDefaultFloodGrid() {
    ...
    for (let r = 0; r < 8; r++) {
      ...
      for (let c = 0; c < 8; c++) {
        ...
        if ((r === 1 && c === 1) || (r === 6 && c === 6) || (r === 4 && c === 3) || (r === 2 && c === 5)) {
          row.push(0.8);
        } else if ((r + c) % 4 === 0) {
          row.push(0.4);
        } else {
  ...
  createDrainagePile() {
    ...
    const pileBg = this.add.rectangle(
      ...
      0x2f4f4f, 
      0.3
    ).setDepth(4).setStrokeStyle(2, 0x5f7f7f, 0.5);
    ...
    for (let i = 0; i < drainageCount; i++) {
      const drainage = this.add.sprite(
