...
export default class heatGameScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.anims.create({
      key: "wheat_anim",
      frames: this.anims.generateFrameNumbers("wheat", { start: 0, end: 3 }),
      frameRate: 8,
      repeat: -1,
    });
    ...
    this.anims.create({
      key: "wheat_grow_anim",
      frames: this.anims.generateFrameNumbers("wheat", {
        start: 0,
        end: 3,
      }),
      frameRate: 1,
    ...
    this.anims.create({
      key: "wheat_sink_anim",
      frames: this.anims.generateFrameNumbers("wheat_sink", {
        start: 0,
        end: 3,
      }),
      frameRate: 1,
    ...
    this.anims.create({
      key: "wheat_burn_anim",
      frames: this.anims.generateFrameNumbers("wheat_burn", {
        start: 0,
        end: 3,
      }),
      frameRate: 1,
