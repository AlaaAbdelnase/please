...
const dialogPhases = {
  introduction: [
    "Welcome to Flood Stories! Drag straw to protect the farm from heavy rain."
  ],
  victory: [
    "Great job! You've protected the farm from flooding!"
  ]
};
...
checkSpacePressed() {
  ...
  createFarmerSprite() {
    ...
    this.farmer = this.add.sprite(width * 0.15, height * 0.8, 'farmer')
  ...
  createMulchPile() {
    ...
    // Define pile area
    this.pileArea = { x: width * 0.1, y: height * 0.85 -50 };
