...
export class SalinizedFarmScene extends Phaser.Scene {
  ...
  preload() {
    ...
    //load audios
    this.load.audio("buttonClick", "assets/audios/click_sho.mp3");
  ...
  create() {
    ...
    if (!this.anims.exists("salty_wheat")) {
      this.anims.create({
        key: "salty_wheat",
        frames: this.anims.generateFrameNumbers("salty_wheat", {
          start: 0,
          end: 0,
        }),
        frameRate: 1,
    ...
    if (!this.anims.exists("water_wheat")) {
      this.anims.create({
        key: "water_wheat",
        frames: this.anims.generateFrameNumbers("water_wheat", {
          start: 0,
          end: 0,
        }),
        frameRate: 1,
    ...
    if (!this.anims.exists("green_wheat")) {
      this.anims.create({
        key: "green_wheat",
        frames: this.anims.generateFrameNumbers("green_wheat", {
          start: 0,
          end: 0,
        }),
        frameRate: 1,
